...
// Вызов окна с контактами по клику иконки и убирание по клику вне области
$(".map__i").click(function() {
  $('#map-collapse').toggleClass('d-block');
});
$(document).on('click', function(e) {
  if (!$(e.target).closest(".off").length) {
    $('#map-collapse').removeClass('d-block');
  }
  e.stopPropagation();
});
